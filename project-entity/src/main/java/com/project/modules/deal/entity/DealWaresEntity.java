...
@TableName("deal_wares")
public class DealWaresEntity implements Serializable {
    private static final long serialVersionUID = -8596322599748478618L;
    ...
    /**审核状态 0.驳回 1.销售审核中 2.经理审核中*/
    @ApiModelProperty(value = "状态 0.审核失败 1.待审核 2.上架 3.下架")
